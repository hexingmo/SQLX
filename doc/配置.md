...
sqlx:
  ...
  - name: cluster_0
    defaulted: true
    read-load-balance-class: com.github.sqlx.loadbalance.WeightRandomLoadBalance
    write-load-balance-class: com.github.sqlx.loadbalance.WeightRandomLoadBalance
    writable-nodes:
      - write_0
    readable-nodes:
      - read_0
...
针对集群可配置不同的负载均衡策略。如果没有配置默认使用 `com.github.sqlx.loadbalance.WeightRandomLoadBalance`.
