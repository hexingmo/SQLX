 ...
 * @since 1.0
 */
public class AnnotationSqlCallableStatement extends AnnotationSqlPreparedStatement implements CallableStatement {

    private final CallableStatement callableStatement;

    public AnnotationSqlCallableStatement(CallableStatement delegate, AnnotationSqlHintParser parser) {
        super(delegate, parser);
        this.callableStatement = delegate;
    }
