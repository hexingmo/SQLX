...
public class ProxyCallableStatement extends ProxyPreparedStatement implements CallableStatement {
    ...
    public ProxyCallableStatement(SqlXDataSource sqlXDataSource, CallableStatementInfo callableStatementInfo, CallableStatement callableStatement , EventListener eventListener) {
        super(sqlXDataSource, callableStatementInfo, eventListener);
        this.delegate = callableStatement;
        this.callableStatementInfo = callableStatementInfo;
    }
    ...
    public void setObject(String parameterName, Object x, SQLType targetSqlType, int scaleOrLength) throws SQLException {
        ...
        try {
            ...
            callableStatementInfo.addException(e);
            eventListener.onAfterCallableStatementSet(callableStatementInfo, parameterName, x, e);
        }
    }
    ...
    public void setURL(String parameterName, URL val) throws SQLException {
        ...
        try {
            ...
            callableStatementInfo.addException(e);
            eventListener.onAfterCallableStatementSet(callableStatementInfo, parameterName, val, e);
        }
    }
    ...
    public void setNull(String parameterName, int sqlType) throws SQLException {
        ...
        try {
            ...
            callableStatementInfo.addException(e);
            eventListener.onAfterCallableStatementSet(callableStatementInfo, parameterName, null, e);
        }
    }
    ...
    public void setCharacterStream(String parameterName, Reader reader, int length) throws SQLException {
        ...
        try {
            ...
            callableStatementInfo.addException(e);
            eventListener.onAfterCallableStatementSet(callableStatementInfo, parameterName, reader, e);
        }
    }
    ...
    public void setNString(String parameterName, String value) throws SQLException {
        ...
        try {
            ...
            callableStatementInfo.addException(e);
            eventListener.onAfterCallableStatementSet(callableStatementInfo, parameterName, value, e);
        }
    }
    ...
    public void setBlob(String parameterName, InputStream inputStream, long length) throws SQLException {
        ...
        try {
            ...
            callableStatementInfo.addException(e);
            eventListener.onAfterCallableStatementSet(callableStatementInfo, parameterName, inputStream, e);
        }
    }
    ...
    public void setSQLXML(String parameterName, SQLXML xmlObject) throws SQLException {
        ...
        try {
            ...
            callableStatementInfo.addException(e);
            eventListener.onAfterCallableStatementSet(callableStatementInfo, parameterName, xmlObject, e);
        }
    }
