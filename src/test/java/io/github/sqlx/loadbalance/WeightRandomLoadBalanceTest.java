package io.github.sqlx.loadbalance;
...
/**
 * Unit tests for {@link WeightRandomLoadBalance}.
 * This class tests the behavior of WeightRandomLoadBalance when choosing nodes based on weights and node states.
 */
class WeightRandomLoadBalanceTest {

    private Set<NodeAttribute> nodes;
    private WeightRandomLoadBalance loadBalancer;
    ...
    void setUp() {
        ...
        loadBalancer = new WeightRandomLoadBalance(nodes);
    }
